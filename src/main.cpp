...
#if defined(NDEBUG)
# error "kenzcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x26d7308df84969030d5297f052c04b5926189adbfba2cbf8664b43fc5f9b05ca");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // kenzcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "kenzcoin Signed Message:\n";
...
{
    // kenzcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
   int64 nSubsidy = 0.000001 * COIN;
    ...
    nSubsidy >>= (nHeight / 840000); // kenzcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 30; // kenzcoin: 5 minutes
static const int64 nTargetSpacing = 1 * 30; // kenzcoin: 30 Seconds.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // kenzcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // kenzcoin: Special short-term limits to avoid 10,000 BDB lock limit:
    if (GetBlockTime() < 1491305276)  // stop enforcing 15 August 2013 00:00:00
    {
        ...
        if (nTxids > 4500)
            return error("CheckBlock() : 04 April maxlocks violation");
    }
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x26d7308df84969030d5297f052c04b5926189adbfba2cbf8664b43fc5f9b05ca");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043319800fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7703a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
       block.nTime    = 1483270076;
        ...
        assert(block.hashMerkleRoot == uint256("0xa20316dbd12cce17bfc3e9bcf37afc426d119e74b6e69e1575631b69e3143af3"));
...
unsigned char pchMessageStart[4] = { 0xf1, 0xc3, 0xb2, 0xbd }; // kenzcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("kenzcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("kenzcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static kenzcoinMiner(CWallet *pwallet)
{
    printf("kenzcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("kenzcoin-miner");
    ...
    try { loop {
        ...
        printf("Running kenzcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("kenzcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&kenzcoinMiner, pwallet));
}
