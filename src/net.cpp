...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "urichiecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
	 {"162.213.255.237", "162.213.255.237"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kenzcointools.com", "testnet-seed.kenzcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. urichiecoin is probably already running."), addrBind.ToString().c_str());
        else
